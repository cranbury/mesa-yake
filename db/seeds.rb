...
<<<<<<< HEAD
Mesa.create(restaurant_id: 2, name: "Table 1 lobby", seats: 4, available: true)
Mesa.create(restaurant_id: 2, name: "Table 2 Bar", seats: 4, available: true)
Mesa.create(restaurant_id: 3, name: "Table 0", seats: 4, available: true)
Mesa.create(restaurant_id: 3, name: "Table 1", seats: 4, available: true)
=======
